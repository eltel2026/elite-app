...
export let doc, getDoc, setDoc, updateDoc, onSnapshot, collection, query, where, orderBy, limit, serverTimestamp, runTransaction;
...
if (isFirebaseConfigured) {
  ...
  ({ doc, getDoc, setDoc, updateDoc, onSnapshot, collection, query, where, orderBy, limit, serverTimestamp, runTransaction } = fsMod);
}
